...
{
    public interface QIDrawingCommand : ICommand
    {
        Task Undo();
        Task Redo();
    }
    ...
    {
        private readonly QIDrawingContext _context;
        private ObservableCollection<QIDrawingObject> _drawingObjects => _context.Objects;
        ...
        public async Task ExecuteAsync()
        {
            try
            {
                ...
                IEnumerable<QIDrawingObject> potentialTargets = _context.SpatialIndex.Search(queryEnvelope);
